...
four_roll = [2, 2, 2, 2, 1]
three_roll = [1, 2, 3, 3, 3]
small_straight_roll = [1, 2, 3, 4, 6]
...
puts "#{turn.points(yacht_roll)} should equal greater than +50"
...
puts "#{turn.points(three_roll)} should equal +9"
puts "#{turn.points(small_straight_roll)} should equal +30"
puts 